...
public class MyHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		try {
			...
			db.execSQL("insert into tMember(fName, lName, age, phoneNumber, bigo) values('hyunji','kim', 40, '123456', 4 );");
			db.execSQL("insert into tMember(fName, lName, age, phoneNumber, bigo) values('hyunji','kim', 30, '123456', 3 );");
			Log.v(TAG, "success");
